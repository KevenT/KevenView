package com.keven.ripplediffusionview.view;
...
import com.keven.ripplediffusionview.R;
...
public class RippleDiffusionView extends View {
     ...
     * 速度
     */
    private int speed = DEFAULT_DELAY_TIME;
    /**
     * 个数
     */
    ...
    public RippleDiffusionView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.mRippleDiffusionView);
        mRippleColor = typedArray.getColor(R.styleable.mRippleDiffusionView_rdcolor, mRippleColor);
        speed = typedArray.getInt(R.styleable.mRippleDiffusionView_rdspeed, speed);
        count = typedArray.getInt(R.styleable.mRippleDiffusionView_rdcount, count);
        isFill = typedArray.getBoolean(R.styleable.mRippleDiffusionView_rdisFill, isFill);
        typedArray.recycle();
...
//            mRippleItemList.add(new RippleItem(i * DEFAULT_DELAY_TIME, DEFAULT_DURATION_TIME));
            mRippleItemList.add(new RippleItem(i * speed, speed*count));
        }
    }
